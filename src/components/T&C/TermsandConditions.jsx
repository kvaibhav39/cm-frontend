...
const TermsandConditions = () => {
  return (
    <Box p="2% 8%" height="90%" overflow="scroll">
      <Typography variant="h1">Terms and Conditions</Typography>
      <Typography variant="h5">Last updated: November 03, 2022</Typography>
      <Typography variant="h5">
        Please read these terms and conditions carefully before using Our
        Service.
      </Typography>
      <br />
      <Typography variant="h1">Interpretation and Definitions</Typography>
      <br />
      ...
      <ul>
        ...
        <li>
          <Typography variant="h5">
            ...
            "Us" or "Our" in this Agreement) refers to Check Ministry, Hong
            Kong.
          </Typography>
        </li>
        <li>
        ...
        <li>
          <Typography variant="h5">
            <strong>Website</strong> refers to Check Ministry, accessible from
            www.checkministry.com
          </Typography>
        </li>
        <li>
          <Typography variant="h5">
      ...
      <br />
      <Typography variant="h1">Acknowledgment</Typography>
      <br />
      <Typography variant="h5">
      ...
      <br />
      <Typography variant="h1">Termination</Typography>
      <br />
      <Typography variant="h5">
      ...
      <br />
      <Typography variant="h1">Limitation of Liability</Typography>
      <br />
      <Typography variant="h5">
      ...
      <Typography variant="h5">
        ...
        behalf of its Affiliates and its and their respective licensers and
      ...
      <br />
      <Typography variant="h1">Disputes Resolution</Typography>
      <br />
      <Typography variant="h5">
      ...
      <br />
      <Typography variant="h1">For European Union (EU) Users</Typography>
      <br />
      <Typography variant="h5">
      ...
      <br />
      <Typography variant="h1">United States Legal Compliance</Typography>
      <br />
      <Typography variant="h5">
      ...
      <br />
      <Typography variant="h1">Severability and Waiver</Typography>
      <br />
      ...
      <br />
      <Typography variant="h2">Waiver</Typography>
      <br />
      <Typography variant="h5">
      ...
      <br />
      <Typography variant="h1">Translation Interpretation</Typography>
      <br />
      <Typography variant="h5">
      ...
      <ul>
        <li>
          <Typography variant="h5">
            By email: support@checkministry.com
          </Typography>
        </li>
        <li>
          <Typography variant="h5">
            By visiting this page on our website:{" "}
            <a href="https://www.checkministry.com" target="_blank">
              www.checkministry.com
            </a>
          </Typography>
        </li>
