...
import loginImage from "assets/images/auth/login-image.svg";
import PanelCard from "./../../common/cards/PanelCard";
import waveImage from "assets/images/wave-haikei.png";
      ...
      >
        ...
        >
                    ...
                    >
                      <Grid item>
                        <Grid
                          ...
                          fontWeight="bold"
                          fontSize="24px"
                          color={theme.palette.dark.moderateViolet}
                        >
                          <img src={logo} alt="Accel" width="200" />
                        </Grid>
                      </Grid>
                    </Grid>
                    {children}
          ...
          <Grid
            ...
            alignItems="center"
          >
            <img src={loginImage} alt="Accel" width="350" />
          </Grid>
        </Grid>
      </PanelCard>
    </AuthWrapper>
